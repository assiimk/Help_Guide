...
<hr>
 ...
 $sqlcount="update counter set count=count+1 where id=1";
    ...
    if (mysqli_num_rows($result)>0)
    {
        ...
        {
      echo "<table><tr><td>رقم السؤال</td><td>".$row['hid']."</td></tr><tr><td> السؤال</td><td>".$row['hqus']."</td></tr><tr><td>تاريخ الخبر</td><td>".$row['hdate']."</td></tr><tr><td>القسم</td><td>".$row['cid']."</td></tr><tr><td> الجواب</td><td>".$row['hanswer']."</td></tr><tr><td> الكلمات المفتاحية</td><td>".$row['hkey']."</td></tr><tr><td>الادوات</td><td><a href=as_delete.php?id=".$row["hid"]."> حذف </a></td></tr></table><hr>";
        }
    }else{
          echo "لاتوجد اسئلة ";
    }
