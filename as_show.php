...
?>
<html dir="rtl">
    <title> الموافقة على الاسئلة</title>
...
<hr>
 ...
 $sqlcount="update counter set count=count+1 where id=1";
    ...
    if (mysqli_num_rows($result)>0)
    {
        ...
        {
      echo "<table><tr><td>السؤال</td><td>".$row['hqus']."</td></tr><tr><td>التاريخ </td><td>".$row['hdate']."</td></tr><tr><td>القسم</td><td>".$row['cid']."</td></tr> <tr><td> الجواب</td><td>".$row['hanswer']."</td></tr><tr><td>الرد</td><td><a href=as_yes.php?id=".$row["hid"].">قبول   </a><br><a href=as_no.php?id=".$row["hid"]."> رفض </a></td></tr></table><hr>";
